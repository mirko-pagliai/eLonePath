...
class ErrorView extends View
{
     ...
     *
     * Sets up the view with:
     *
     * - Default template path (`TEMPLATES` constant)
     * - Error layout (`layouts/error.php`)
     *
     * @return void
     */
     ...
     *
     * If DEBUG mode is enabled and an exception is provided, the exception object
     ...
     */
    private function determineTemplate(int $statusCode): string
    {
