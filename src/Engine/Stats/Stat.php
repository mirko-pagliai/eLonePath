...
namespace eLonePath\Engine\Stats;

use InvalidArgumentException;

/**
 * Represents an abstract statistical metric with a current and maximum value.
 *
 * This is the base class for all character attributes (skill, stamina, luck... and others that could be implemented).
 */
abstract class Stat
{
    /**
    ...
    {
        return new static(max: $data['max'], current: $data['current']);
    }
}
